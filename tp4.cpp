...
void drawScene(){
	...
	glPushMatrix();
		glBegin(GL_QUADS);
			glTexCoord2f(0.0f,0.0f); glVertex3i( 0,  0, 0 );
			glTexCoord2f(10.0f,0.0f); glVertex3i( zC/2, 0, 0 );
			glTexCoord2f(10.0f,10.0f); glVertex3i( zC/2, zC/2, 0);
			glTexCoord2f(0.0f,10.0f); glVertex3i( 0,  zC/2,  0);
		glEnd();
	glPopMatrix();
	glDisable(GL_TEXTURE_2D);
	...
	glPushMatrix();
		glBegin(GL_QUADS);
			glTexCoord2f(0.0f,0.0f); glVertex3i( 0,  0, 0 );
			glTexCoord2f(10.0f,0.0f); glVertex3i( 0, yC, 0 );
			glTexCoord2f(10.0f,10.0f); glVertex3i( 0, yC, yC);
			glTexCoord2f(0.0f,10.0f); glVertex3i( 0,  0,  yC);
		glEnd();
	glPopMatrix();
	glDisable(GL_TEXTURE_2D);
	//*****************************************************
